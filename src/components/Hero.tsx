    ...
    <div className="relative">
      ...
      <div className="container relative px-4 lg:px-8 py-16 lg:py-32">
        ...
        <h2 className="md:text-lg lg:text-xl font-medium leading-relaxed text-white opacity-80 lg:w-2/3">
          Welcome to Titan Alloys LLC, where the discarded becomes invaluable.
          As an Illinois (USA) based Metal Trading Company, we specialize in the
          intricate processes of handling, recycling, and trading both Ferrous
          and Non-Ferrous alloys. Our commitment to excellence is exemplified in
          our expertise in sorting and processing high-value materials such as
          Tungsten Carbide, Toolsteel, and High Temp Alloys.
        </h2>
