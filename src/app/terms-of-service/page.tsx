...
export const metadata = {
  title: 'Terms of Service | Titan Alloys LLC',
  description: 'Please read these terms and conditions of use carefully before using this site',
